  ...
  return (
    <div className="grid grid-cols-2 gap-6 p-6">
      ...
      <div className="space-y-4">
        <h1 className="text-2xl font-bold">Austin Console</h1>
      ...
      {/* RIGHT PANEL */}
      <div className="space-y-4">
        <h2 className="text-xl font-semibold">Austin Output</h2>

        {loading && <p className="text-blue-600">Austin is thinking...</p>}
        ...
        {result && (
          <div className="space-y-4">
            ...
            <div className="rounded-lg border p-4">
              ...
              <p className="text-lg">{result.confidence.value}%</p>
            </div>
          </div>
        )}
      </div>
