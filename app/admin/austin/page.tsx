      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        <header className="rounded-2xl border border-slate-800 bg-slate-950/80 p-6 shadow-2xl shadow-black/20">
          ...
          <h1 className="mt-3 text-4xl font-semibold text-white">
            The operational brain of GuavaCheck
          </h1>
          <p className="mt-3 max-w-3xl text-sm text-slate-400">
            Austin continuously monitors the platform, prioritizes what needs attention, and
            recommends actions before customers feel the impact.
          </p>
        </header>
