...
class DocumentAnalyzer:
    ...
    def analyze(self, document):
        ...
        result = {
            ...
            "owner": self.extract_owner(text),
            "property_reference": self.extract_property_reference(text),
            "dates": self.extract_dates(text),
            "risk_flags": self.detect_anomalies(text),
        }
    ...
    def detect_anomalies(self, text):
        ...
        if len(text) < 20:
            flags.append("Insufficient document content")
