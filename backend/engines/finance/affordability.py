...
class AffordabilityEngine:
    ...
    def calculate(
        ...
        disposable_income = monthly_income - monthly_expenses - existing_debt
        ...
        affordability_ratio = (disposable_income / monthly_income) * 100
        ...
        estimated_budget = disposable_income * 60
    ...
    def compare_property(
        ...
        difference = buyer_budget - property_price

        if difference >= 0:
            decision = "AFFORDABLE"

        elif difference > (property_price * -0.25):
