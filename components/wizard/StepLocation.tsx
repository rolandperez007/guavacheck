...
export default function StepLocation() {
  ...
  function updateField(field: keyof typeof location, value: string) {
    updateWizard({
      location: {
        ...location,
        [field]: value,
  ...
  return (
    <FormCard>
      ...
      <div className="mt-10 rounded-xl border border-dashed border-green-300 bg-green-50 p-8 text-center">
        ...
        <p className="mt-2 text-gray-600">Coming in the next update.</p>

        <p className="text-sm text-gray-500 mt-2">
          Users will be able to drop a pin, detect GPS, or search any address worldwide.
        </p>
      </div>
    </FormCard>
  );
