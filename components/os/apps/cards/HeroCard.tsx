  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-neutral-800 bg-gradient-to-br from-black via-neutral-950 to-neutral-900 p-10">
      ...
      <div className="relative z-10 max-w-3xl">
        <p className="text-sm uppercase tracking-[0.35em] text-emerald-400">Guava Intelligence</p>
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-neutral-300">
          Search, verify, analyse and invest with Austin AI while monitoring markets across the
          world from a single workspace.
        </p>
