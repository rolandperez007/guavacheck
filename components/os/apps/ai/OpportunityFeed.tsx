  ...
  return (
    <section className="rounded-3xl border border-neutral-800 bg-neutral-950 p-8">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-semibold">AI Opportunities</h2>
          ...
          >
            <div className="flex justify-between">
              ...
              <div className="text-right">
                <div className="text-xl font-bold text-emerald-400">{item.roi}</div>

                <div className="text-sm text-neutral-500">Confidence {item.confidence}</div>
              </div>
            </div>
          </div>
        ))}
