...
class ProviderRegistry:
    ...
    def get_priority_sources(self) -> list[str]:
        ...
        priority = self.data.get("provider_priority", [])

        return [item.get("provider") for item in priority]
    ...
    def get_reliability(
        ...
        return provider.get("reliability_weight", 0.0)
    ...
    def supports_authentication(
        ...
        return provider.get("requires_authentication", False)
    ...
    def get_integration_types(
        ...
        return provider.get("integration_type", [])
    ...
    def summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "categories": list(
                set(provider.get("category") for provider in self.providers)
            ),
            "authenticated_sources": len(
                [p for p in self.providers if p.get("requires_authentication")]
            ),
        }
