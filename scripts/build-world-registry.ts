...
const registryPath = path.join(process.cwd(), "knowledge", "countries", "registry.json");

const outputPath = path.join(process.cwd(), "knowledge", "countries", "countries.json");
...
const registry: CountrySeed[] = JSON.parse(fs.readFileSync(registryPath, "utf8"));
